...
def test_public_account_index_alone_does_not_initialize_wechat_profile(tmp_path):
    (tmp_path / ".public-account-index.json").write_text('{"version":2,"accounts":{}}', encoding="utf-8")
    (tmp_path / ".public-account-index.json.tmp.123").write_text("pending", encoding="utf-8")
